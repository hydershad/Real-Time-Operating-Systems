...
struct tcb{
	...
	struct tcb *next;
	struct tcb *parent;
	unsigned long sleepNumber;
	int Identifier;
	unsigned long priority;
	int semaphore;
	struct tcb *sema4Link;
	int PCBid;
...
typedef struct sleepList Sleep;
// ******** OS_Init ************
...
int OS_AddThread1(void(*task)(void), 
   unsigned long stackSize, unsigned long priority, int id);
//******** OS_Id *************** 
